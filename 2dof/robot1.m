close all; clear all;l1=2;l2=2;l3=3;th1=0;th2=0;
testmodel;plot(xy(1,:),xy(2,:),'o-','linewidth',5);
...
set(ui1,'position',[10,25,60,20],'callback','sub1');
set(ui2,'position',[10,65,60,20],'callback','sub1');
